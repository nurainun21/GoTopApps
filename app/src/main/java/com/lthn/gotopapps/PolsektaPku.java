...
public class PolsektaPku extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                ...
                String smsText = "Saya membutuhkan bantuan !";
                a = new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:082298994153"));
                ...
                String website = "https://polsekta-Pekanbaru.com";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(website));
            } else if (pilihan.equals("Info di Google")) {
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY, "Polsekta Pekanbaru");
